...
const steps = [
  ...
  { title: "Download and practice", desc: "Start learning immediately." },
];
...
const PricingCard = ({ name, price, features: list, highlight }: PricingCardProps) => (
  <div
...
type WorksheetSubscriptionLayoutProps = {
  title: string;
  subtitle: string;
  description: string;
  heroImage: string;
...
const WorksheetSubscriptionLayout = ({
  title,
  subtitle,
  description,
  heroImage,
  dashboardImage,
}: WorksheetSubscriptionLayoutProps) => (
        ...
        <div className="container mx-auto px-4 max-w-7xl py-20 md:py-28 relative z-10">
          <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-10 items-center">
            <div className="text-left text-white">
              ...
              <p className="mt-4 text-lg md:text-xl text-white/80">{subtitle}</p>
              <p className="mt-4 text-white/75 max-w-xl">{description}</p>
              <div className="mt-8">
...
export default WorksheetSubscriptionLayout;
