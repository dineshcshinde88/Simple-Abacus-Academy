...
export const trainingShopProducts: TrainingShopProduct[] = [
  ...
  },
  {
    ...
    category: "Abacus Kits",
    description: "Level-wise regular kit for continuing students with classwork and homework books.",
    includes: ["2 Books (Classwork + Homework)", "1 Certificate"],
    optionLabel: "Level",
    image: abacusKitRegularImage,
    options: abacusLevels.map((label) => ({ label, price: 235 })),
  },
  {
  ...
  },
  {
    ...
    description: "Level-wise Vedic Maths book.",
    includes: ["1 Book"],
    optionLabel: "Level",
