...
const VedicMathsWorksheetSubscription = () => {
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            <div className="mt-8 grid items-start gap-6 lg:grid-cols-[420px_1fr]">
              <div className="w-full aspect-[4/3] overflow-hidden rounded-2xl bg-gradient-to-br from-orange-300 via-orange-400 to-orange-500 shadow-card">
                <div className="relative h-full p-6">
                  <div className="absolute left-6 top-6 flex flex-col gap-2">
                    {["Quick Tricks", "Smart Methods", "Solve In Seconds", "Time-Saving Skills"].map((pill) => (
                      <span
                        key={pill}
                        className="w-fit rounded-full bg-purple-600 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-white shadow-sm"
                      >
                        {pill}
                      </span>
                    ))}
              ...
              <div className="rounded-2xl border border-border bg-white p-6 shadow-card">
                <div className="flex flex-wrap items-center justify-between gap-4">
                  <h3 className="text-2xl font-heading font-bold text-orange-500">Vedic Maths</h3>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-between gap-4">
              <Button className="rounded-full bg-[#4B1E83] px-6 py-6 text-sm font-semibold text-white hover:bg-[#3c176a]" asChild>
                <Link to="/abacus-worksheet-subscription">Buy Abacus Worksheets</Link>
              </Button>
              <Button className="rounded-full bg-[#4B1E83] px-6 py-6 text-sm font-semibold text-white hover:bg-[#3c176a]" asChild>
...
export default VedicMathsWorksheetSubscription;
