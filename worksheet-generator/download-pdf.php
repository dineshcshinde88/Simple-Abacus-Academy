...
$pdf->Cell(0, 10, 'Simple Abacus', 0, 1, 'C');
$pdf->SetFont('Arial', 'B', 16);
$pdf->Cell(0, 10, 'Worksheet', 0, 1, 'C');
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(0, 6, 'Generated by Simple Abacus Worksheet Generator', 0, 1, 'C');
$pdf->Ln(2);
...
$pdf->Output('D', 'simple-abacus-worksheet-' . $id . '.pdf');
?>
