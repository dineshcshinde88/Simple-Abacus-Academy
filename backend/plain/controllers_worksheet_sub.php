...
function worksheet_sub_vedic_topic_specs(int $levelNumber): array
{
    $levels = [
        1 => [
            ...
            ['slug' => 'multiplication-2d-x-2d', 'name' => 'Multiplication: 2D x 2D', 'kind' => 'multiply', 'a' => [10, 99], 'b' => [10, 99]],
            ['slug' => 'multiplication-3d-x-2d', 'name' => 'Multiplication: 3D x 2D', 'kind' => 'multiply', 'a' => [100, 999], 'b' => [10, 99]],
            ['slug' => 'multiplication-4d-x-2d', 'name' => 'Multiplication: 4D x 2D', 'kind' => 'multiply', 'a' => [1000, 9999], 'b' => [10, 99]],
            ['slug' => 'multiplication-5d-x-2d', 'name' => 'Multiplication: 5D x 2D', 'kind' => 'multiply', 'a' => [10000, 99999], 'b' => [10, 99]],
            ['slug' => 'multiplication-6d-x-2d', 'name' => 'Multiplication: 6D x 2D', 'kind' => 'multiply', 'a' => [100000, 999999], 'b' => [10, 99]],
            ['slug' => '99-multi-2d-x-2d', 'name' => '99 Method Multiplication: 2D x 2D', 'kind' => 'fixed_multiply', 'a' => [10, 98], 'fixed' => 99],
            ['slug' => '99-multi-3d-x-3d', 'name' => '99 Method Multiplication: 3D x 3D', 'kind' => 'fixed_multiply', 'a' => [100, 998], 'fixed' => 999],
            ['slug' => '99-multi-4d-x-4d', 'name' => '99 Method Multiplication: 4D x 4D', 'kind' => 'fixed_multiply', 'a' => [1000, 9998], 'fixed' => 9999],
            ...
            ['slug' => 'vertical-crosswise-2d', 'name' => 'Vertical & Crosswise Multiplication (2D)', 'kind' => 'multiply_no_zero', 'a' => [21, 88], 'b' => [21, 88]],
        ...
        3 => [
            ...
            ['slug' => 'vertical-crosswise-3d', 'name' => 'Vertical & Crosswise Multiplication (3D)', 'kind' => 'multiply_no_zero', 'a' => [111, 888], 'b' => [111, 888]],
        ...
        4 => [
            ['slug' => 'vertical-crosswise-4d', 'name' => 'Vertical & Crosswise Multiplication (4D)', 'kind' => 'multiply_no_zero', 'a' => [1111, 8888], 'b' => [1111, 8888]],
            ...
            ['slug' => 'duplex-square-6-digit', 'name' => 'Duplex Square: 6 Digit', 'kind' => 'power_prompt', 'power' => 2, 'range' => [100000, 999999], 'prompt' => 'Find square'],
            ...
            ['slug' => 'calendar-method', 'name' => 'Calendar Calculation Method', 'kind' => 'calendar'],
        ],
    ];
